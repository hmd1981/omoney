...
const pageMeta: Record<Locale, Record<PublicPage, { title: string; description: string }>> = {
  fa: {
    about: {
      title: 'درباره او مانی | تجربه، اعتماد و حواله بین‌المللی',
      description: 'درباره او مانی، صرافی و خدمات حواله بین‌المللی با تجربه منطقه‌ای در عمان، امارات، ایران و ترکیه.'
    },
    services: {
      title: 'خدمات او مانی | حواله، تبدیل ارز و مشاوره مسیر انتقال',
      description: 'خدمات حواله بین‌المللی، تبدیل ارز، بررسی مدارک، مشاوره مسیر انتقال و خدمات بیزینس در او مانی.'
    },
    rates: {
      title: 'نرخ ارز و طلا | او مانی',
      description: 'مشاهده نرخ‌های به‌روز ارزهای اصلی، دارایی‌های دیجیتال منتخب، طلا و سکه در او مانی.'
    },
    faq: {
      title: 'سوالات متداول | او مانی',
      description: 'پاسخ به سوالات رایج درباره حواله، نرخ ارز، مدارک، زمان پردازش و خدمات او مانی.'
    },
    contact: {
      title: 'تماس با او مانی | عمان، ترکیه و ایران',
      description: 'راه‌های تماس با او مانی، شماره‌های عمان، ترکیه، ایران، ایمیل، تلگرام، اینستاگرام و موقعیت دفاتر.'
    },
    terms: {
      title: 'قوانین استفاده | او مانی',
      description: 'قوانین و شرایط استفاده از خدمات حواله، تبدیل ارز و پشتیبانی او مانی.'
    },
    privacy: {
      title: 'حریم خصوصی | او مانی',
      description: 'نحوه نگهداری، استفاده و حفاظت از اطلاعات کاربران در پلتفرم او مانی.'
    }
  },
  en: {
    about: {
