          ...
          <article className="surface-glass overflow-hidden rounded-xl p-6">
            ...
            <p className="mt-4 leading-8 text-[#5f6b78]">
              {locale === 'fa'
                ...
                : locale === 'ar'
                  ? 'تنبيهات مكافحة الاحتيال ومراجعة الإيصالات وقيود رفع الملفات وسجل تشغيلي واضح لتقليل مخاطر التحويل الدولي.'
          ...
          <article className="surface-glass overflow-hidden rounded-xl p-6">
            ...
            <p className="mt-4 leading-8 text-[#5f6b78]">
              {locale === 'fa'
                ...
                : locale === 'ar'
                  ? 'التحقق من الهوية وضوابط الامتثال في أوماني لحماية العملاء ومسارات الأموال.'
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 md:px-6">
          ...
          <p className="mt-4 max-w-2xl text-white/70">
            {locale === 'fa'
              ...
              : locale === 'ar'
                ? 'صرافة في مسقط ودبي وإسطنبول — علامة واحدة بمعايير مؤسسية.'
