...
const corridorConfig = [
  ...
  { baseCurrency: 'AED', fa: 'درهم امارات', en: 'UAE Dirham', exampleAmount: 1000 },
  { baseCurrency: 'TRY', fa: 'لیر ترکیه', en: 'Turkish Lira', exampleAmount: 10000 },
  { baseCurrency: 'EUR', fa: 'یورو', en: 'Euro', exampleAmount: 1000 },
  { baseCurrency: 'USD', fa: 'دلار آمریکا', en: 'US Dollar', exampleAmount: 1000 },
  { baseCurrency: 'CAD', fa: 'دلار کانادا', en: 'Canadian Dollar', exampleAmount: 1000 }
] as const;

const currencyMeta: Record<string, { fa: string; en: string }> = {
...
export function HomepageMarketPanel({ locale }: { locale: 'fa' | 'en' }) {
