...
const stepsContent = {
  ...
  ar: [
    ...
    'مراجعة المستندات وتأكيد السعر',
    'رفع إيصال الدفع',
    'المعالجة والتأكيد النهائي'
  ]
} as const;
    ...
    <section className="section-band bg-[#fcfbf8]">
      <div className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-20">
        <div className="max-w-2xl">
          <p className="eyebrow">{fa ? 'فرآیند روشن' : ar ? 'عملية واضحة' : 'Clear process'}</p>
          ...
          <p className="mt-4 text-base leading-8 text-[#5f6b78]">
            {fa
              ...
              : ar
                ? 'تحويلات دولية مع أوماني — كل مرحلة قابلة للمتابعة من التسجيل حتى الإكمال.'
